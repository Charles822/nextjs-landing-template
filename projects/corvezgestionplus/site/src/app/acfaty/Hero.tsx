...
import { ArrowRight, Check, Award, Car, Shield } from "lucide-react";
    ...
    <section className="grid lg:grid-cols-12 min-h-[640px]">
      ...
      <div className="lg:col-span-7 lg:px-12 flex flex-col z-10 pt-16 pr-6 pb-12 pl-6 relative justify-center">
        ...
        <p className="text-lg text-neutral-500 max-w-xl leading-relaxed mb-10 font-normal">
          VTC, Taxi, transport de personnes : nous vous accompagnons de l'idée à l'exploitation.{" "}
          <span className="font-medium text-neutral-800">
            Expertise réglementaire pointue
          </span>{" "}
          pour créer une entreprise viable et conforme.
        </p>
          ...
          <div className="flex items-center gap-4">
            <div className="text-xs font-medium text-neutral-600 flex gap-4">
              <div className="flex items-center gap-2">
                ...
                <span>Expertise<br/>réglementaire</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-[#eff6ff] flex items-center justify-center text-[#0065c2]">
                  <Car className="w-4 h-4" />
                </div>
                <span>VTC · Taxi<br/>Transport</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="lg:col-span-5 lg:h-auto overflow-hidden w-full h-[500px] relative">
        ...
        <Image
          src="/hero-acfaty.jpg"
          alt="Chauffeur professionnel VTC - Acfaty"
          fill
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-100">De la création à l'exploitation</p>
                  </div>
                </div>
              </div>
