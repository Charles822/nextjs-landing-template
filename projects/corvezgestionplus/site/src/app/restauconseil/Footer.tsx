    ...
    <footer className="bg-slate-900 text-slate-400 py-12 lg:px-12 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-white">Restauconseil</span>
            </div>
            <p className="text-sm mb-4 max-w-sm">
              Bureau d'étude et de conseil spécialisé en ingénierie de la restauration et aménagement de cuisines professionnelles depuis 1978.
            </p>
        ...
        <div className="pt-8 border-t border-slate-800 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Restauconseil. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
