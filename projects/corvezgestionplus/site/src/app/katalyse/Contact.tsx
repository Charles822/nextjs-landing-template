        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-lg text-slate-500 mb-8">
              Vous avez un projet de développement, une réflexion stratégique à mener, ou une due diligence à réaliser ?
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-slate-600">
                ...
                <span>contact@katalyse.com</span>
              </div>
              <div className="flex items-center gap-3 text-slate-600">
                <div className="w-10 h-10 rounded-full bg-[#eff6ff] flex items-center justify-center text-[#0065c2]">
                  <MapPin className="w-5 h-5" />
                </div>
                <span>Lyon · Nantes · Paris · Strasbourg</span>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="revitalisation">Revitalisation</option>
